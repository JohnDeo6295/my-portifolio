...
import { CodepenIcon, ActivityIcon, MobileIcon } from "./icons"; // reuse icons

// Updated skills based on John Maliwa's profile
const skillCategories = {
  web: {
    title: "Web & Mobile Development",
    icon: CodepenIcon,
    description: "Building responsive web and mobile applications",
    languages: ["Next.js", "Expo"],
    tools: ["Visual Studio Code", "Git", "Github", "Figma", "Postman"],
  },
  engineering: {
    title: "Industrial & Mechanical Engineering",
    icon: ActivityIcon,
    description: "Practical engineering skills for design and optimization",
    languages: [
      "SolidWorks",
      "AutoCAD",
      "MATLAB",
    ...
    tools: [
      ...
      "Minitab",
      "AutoCAD",
      "Python (for engineering scripts)",
    ],
  },
  mobile: {
    title: "Mobile Development",
    icon: MobileIcon,
    description: "Cross-platform mobile app development with Expo",
    languages: ["Expo", "React Native", "JavaScript", "TypeScript"],
    tools: ["Expo CLI", "Android Studio", "Visual Studio Code"],
  },
};
...
function SkillDetails({ selectedSkill }) {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-2xl font-semibold text-black mb-6 text-center">Tools & Technologies</h3>
        <div className="flex flex-wrap justify-center gap-3">
      ...
      <div className="mx-auto container px-6 py-20">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
            Explore my technical and industrial engineering skills across different domains. Click any category to see details.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {Object.entries(skillCategories).map(([key, skill], index) => (
            <motion.div key={key} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }}>
              <SkillCard skill={skill} isSelected={selectedCategory === key} onClick={() => setSelectedCategory(key)} />
            </motion.div>
          ))}
        </div>
