        ...
        <div className="relative h-screen w-screen gap-4 p-10 flex justify-center items-center flex-col mb-10 overflow-hidden">
          <div className="z-0 mb-48 md:mb-0 md:absolute top-1/4 md:right-[10%] md:-translate-y-16">
            <motion.div
              ...
              className="bg-slate-300 rounded-sm h-[400px] md:h-[600px] w-[80vw] md:w-[30vw] relative grayscale hover:grayscale-0">
              <Image
                src="/image/me1.png"
                alt="Disihub Tech Hero"
                fill
                style={{ objectFit: "cover" }}
                placeholder="blur"
                blurDataURL="/image/me1.png"
              />
            </motion.div>
          </div>
          ...
          <div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 pt-4 backdrop-filter backdrop-blur-sm md:backdrop-blur-none md:backdrop-filter-none bg-gray-100 bg-opacity-50 md:bg-transparent md:pt-0">
            <h1 className="md:bg-white bg-transparent lg:bg-transparent bg-opacity-50 text-black text-5xl md:text-8xl font-bold">
              My Projects
            </h1>
            <Hr />
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          <div className="flex justify-center items-start flex-col mb-5">
            <div className="images relative w-full aspect-square">
              {/* Image me1 */}
              <div className="absolute top-28 left-10 h-[40%] w-[40%] relative grayscale hover:grayscale-0 transition-all ease duration-300 hover:scale-150 z-10">
                <motion.div
              ...
              {/* Image me2 */}
              <div className="absolute top-10 right-28 h-[30%] w-[35%] relative grayscale hover:grayscale-0 transition-all ease duration-300 hover:scale-150">
                <motion.div
                  initial={{ opacity: 0, scale: 0.5, x: -100 }}
                  whileInView={{ opacity: 1, scale: 1, x: 0 }}
                  ...
                  <Image
                    ...
                    style={{ objectFit: "cover" }}
                    placeholder="blur"
                    blurDataURL="/image/me2.png"
                  />
                </motion.div>
              </div>

              {/* Image me3 */}
              <div className="absolute bottom-10 right-20 h-[35%] w-[40%] relative grayscale hover:grayscale-0 transition-all ease duration-300 hover:scale-150">
                <motion.div
                  initial={{ opacity: 0, scale: 0.5, x: -100 }}
                  whileInView={{ opacity: 1, scale: 1, x: 0 }}
          ...
          <motion.div
            ...
            <p className="text-gray-600 text-justify title text-lg">
              Disihub Tech projects are designed for innovative digital solutions
              in Tanzania. This project uses Next.js, TailwindCSS, Prisma, and
              Expo for mobile apps. It focuses on scalable web apps and
              practical engineering tools to improve business workflows.
            </p>
            <div className="mt-3 flex gap-3">
              <Button variation="primary">
                <Link href="projects/disihub">More</Link>
              </Button>
              <Button variation="secondary">
                <a href="https://disihub.site" target="_blank" rel="noopener noreferrer">
                  Preview
                </a>
              </Button>
            </div>
